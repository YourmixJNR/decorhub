...
const FlyoutCart = () => {
  return (
    <div>
      <div
        className="fixed w-full h-full top-0 right-0 flex bg-gray-500 bg-opacity-50"
        style={{ zIndex: 50 }}
      >
        <div className="overflow-y-scroll flex flex-col fixed top-0 right-0 gap-6 w-11/12 sm:w-[25.8rem] h-full bg-white py-6 px-6">
          ...
          <div className="text-center">
              ...
              <div className="flex justify-between border-b border-gray-200 py-[0.81rem]">
                <span className="font-inter text-base text-neutral-900">Subtotal</span>
                <p className="font-inter text-base font-semibold text-neutral-900">$99.00</p>
              </div>
              
              <div className="flex justify-between py-[0.81rem] mb-4">
                <span className="font-poppins text-xl font-medium text-neutral-900">Total</span>
                <p className="font-poppins text-xl font-semibold text-neutral-900">$234.00</p>
              </div>
